...
import cob_lote_postman.utils_coblote as utils_coblote, settings.error_messages as error_messages, requests

cob_lote_pt = Blueprint('cob_lote_pt', __name__)
                        
@cob_lote_pt.route('/v2/lotecobv/<id>', methods=['PUT'])
...
@cob_lote_pt.route('/v2/lotecobv/<id>', methods=['PATCH'])
...
@cob_lote_pt.route('/v2/lotecobv/<id>', methods=['GET'])
...
@cob_lote_pt.route('/v2/lotecobv', methods=['GET'])
def cob_lote_get():
