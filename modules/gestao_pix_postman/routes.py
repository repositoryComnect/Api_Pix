...
import gestao_pix_postman.utils_gpix as utils_gpix, settings.error_messages as error_messages

gest_pix_pt = Blueprint('gest_pix_pt', __name__)

## ------------------------------------------- Bloco Rotas Gestão de Pix ----------------------------------------------------------------------------- ##

@gest_pix_pt.route('/v2/pix/<e2eId>', methods=['GET'])
...
@gest_pix_pt.route('/v2/pix', methods=['GET'])
def gest_pix_get():
...
@gest_pix_pt.route('/v2/pix/<e2eId>/devolucao/<id>', methods=['PUT'])
...
@gest_pix_pt.route('/v2/pix/<e2eId>/devolucao/<id>', methods=['GET'])
