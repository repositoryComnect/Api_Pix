...
import pay_location.utils_plocation as utils_plocation, settings.error_messages as error_messages

pay_location_bp = Blueprint('pay_location', __name__)

## ------------------------------------------- Bloco Rotas Payload Locations ----------------------------------------------------------------------------- ##

@pay_location_bp.route('/v2/loc', methods=['GET'])
...
@pay_location_bp.route('/v2/loc', methods=['POST'])
...
@pay_location_bp.route('/v2/loc/<id>', methods=['GET'])
...
@pay_location_bp.route('/v2/loc/<id>/qrcode', methods=['GET'])
...
@pay_location_bp.route('/v2/loc/<id>/txid', methods=['DELETE'])
