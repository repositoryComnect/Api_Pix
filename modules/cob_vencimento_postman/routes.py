...
import cob_vencimento_postman.utils_cobv as utils_cobv, random, authenticate.utils as utils, settings.error_messages as error_messages

cob_vencimento_pt = Blueprint('cob_vencimento_pt', __name__)
...
@cob_vencimento_pt.route('/v2/cobv', methods=['GET'])
...
@cob_vencimento_pt.route('/v2/cobv/<id>', methods=['GET'])
...
@cob_vencimento_pt.route('/v2/cobv/<id>', methods=['PUT'])
...
@cob_vencimento_pt.route('/v2/cobv/<id>', methods=['PATCH'])
