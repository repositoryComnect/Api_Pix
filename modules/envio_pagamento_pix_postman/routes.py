...
import envio_pagamento_pix_postman.utils_envio_pagamento as utils_envio_pagamento, settings.error_messages as error_messages


env_pagamento_pix_pt = Blueprint('env_pagamento_pix_pt', __name__)

# Necessário finalizar
@env_pagamento_pix_pt.route('/v3/gn/pix/', methods=['PUT'])
...
# Necessário finalizar
@env_pagamento_pix_pt.route('/v2/gn/pix/enviados/<id>', methods=['GET'])
...
# Necessário finalizar
@env_pagamento_pix_pt.route('/v2/gn/pix/enviados/id-envio/<id>', methods=['GET'])
...
# Necessário finalizar
@env_pagamento_pix_pt.route('/v2/gn/pix/enviados', methods=['GET'])
...
# Necessário finalizar
@env_pagamento_pix_pt.route('/v2/gn/qrcodes/detalhar', methods=['POST'])
...
# Necessário finalizar
@env_pagamento_pix_pt.route('/v2/gn/pix/<id>/qrcode', methods=['PUT'])
