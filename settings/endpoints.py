...
URL_REQUISITAR_ENVIO_PIX_H = URL_BASE_H + "/v3/gn/pix"
URL_REQUISITAR_ENVIO_PIX_P = URL_BASE_P + "/v3/gn/pix"

URL_ENVIO_PAGAMENTO_PIX_H = URL_BASE_H + "/v2/gn"
URL_ENVIO_PAGAMENTO_PIX_P = URL_BASE_P + "/v2/gn"
